...
public class AdminUserController {
	...
	public ResponseEntity<?> list() {
		try {
			List<MemberDto> list = memberService.listMember(null); //>>>>JSON Array로 바꿔야함.
...
//	}
	...
	@PostMapping("/user")
	public ResponseEntity<?> registUser(@RequestBody MemberDto memberDto) {
		try {
	...
	@PutMapping("/user")
	public ResponseEntity<?> modifyUser(@RequestBody MemberDto memberDto) {
		try {
